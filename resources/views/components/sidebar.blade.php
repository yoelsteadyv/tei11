...
<aside id="sidebar-multi-level-sidebar"
    ...
    <div class="h-full px-3 py-4 overflow-y-auto bg-gray-50 dark:bg-gray-800">
        <ul class="space-y-2 font-medium">
            ...
            <li>{{-- list master barang --}}
                <button type="button"
                    class="flex items-center w-full p-2 text-base text-gray-900 transition duration-75 rounded-lg group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700"
                    aria-controls="dropdown-example" data-collapse-toggle="dropdown-master-barang">
                    <svg class="flex-shrink-0 w-5 h-5 text-gray-500 transition duration-75 group-hover:text-gray-900 dark:text-gray-400 dark:group-hover:text-white"
                        aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 18 21">
                        <path
                            d="M15 12a1 1 0 0 0 .962-.726l2-7A1 1 0 0 0 17 3H3.77L3.175.745A1 1 0 0 0 2.208 0H1a1 1 0 0 0 0 2h.438l.6 2.255v.019l2 7 .746 2.986A3 3 0 1 0 9 17a2.966 2.966 0 0 0-.184-1h2.368c-.118.32-.18.659-.184 1a3 3 0 1 0 3-3H6.78l-.5-2H15Z" />
                    </svg>
                    <span class="flex-1 text-left ms-3 rtl:text-right whitespace-nowrap">Master Barang</span>
                ...
                <ul id="dropdown-master-barang" class="hidden py-2 space-y-2">
                    <li>
                        <a href="/jenis"
                            class="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">Jenis</a>
                    </li>
                    <li>
                        <a href="#"
            ...
            <li>{{-- main supplier --}}
                <a href="#"
                    ...
                    <span class="flex-1 ms-3 whitespace-nowrap">Main Supplier</span>
            ...
            <li>{{-- main customer --}}
                <a href="#"
                    ...
                    <span class="flex-1 ms-3 whitespace-nowrap">Main Customer</span>
            ...
            <li>{{-- barang masuk --}}
                <a href="#"
                    ...
                    <span class="flex-1 ms-3 whitespace-nowrap">Barang Masuk</span>
                    {{-- <span class="inline-flex items-center justify-center w-3 h-3 p-3 text-sm font-medium text-blue-800 bg-blue-100 rounded-full ms-3 dark:bg-blue-900 dark:text-blue-300">3</span> --}}
                </a>
            </li>{{-- end barang masuk --}}
            ...
            <li>{{-- barang keluar --}}
                <a href="#"
                    ...
                    <span class="flex-1 ms-3 whitespace-nowrap">Barang Keluar</span>
                    {{-- <span class="inline-flex items-center justify-center w-3 h-3 p-3 text-sm font-medium text-blue-800 bg-blue-100 rounded-full ms-3 dark:bg-blue-900 dark:text-blue-300">3</span> --}}
                </a>
            </li>{{-- end barang keluar --}}
            ...
            <li>{{-- laporan --}}
                <button type="button"
                    class="flex items-center w-full p-2 text-base text-gray-900 transition duration-75 rounded-lg group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700"
                    aria-controls="dropdown-example" data-collapse-toggle="dropdown-list-laporan">
                    <svg class="flex-shrink-0 w-5 h-5 text-gray-500 transition duration-75 group-hover:text-gray-900 dark:text-gray-400 dark:group-hover:text-white"
                        aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 18 21">
                        <path
                            d="M15 12a1 1 0 0 0 .962-.726l2-7A1 1 0 0 0 17 3H3.77L3.175.745A1 1 0 0 0 2.208 0H1a1 1 0 0 0 0 2h.438l.6 2.255v.019l2 7 .746 2.986A3 3 0 1 0 9 17a2.966 2.966 0 0 0-.184-1h2.368c-.118.32-.18.659-.184 1a3 3 0 1 0 3-3H6.78l-.5-2H15Z" />
                ...
                <ul id="dropdown-list-laporan" class="hidden py-2 space-y-2">
                    <li>
                        <a href="#"
